...
class DressspiderSpider(scrapy.Spider):
    ...
    def parse_product_by_splash(self,response):
        ...
        #通过itemloader方式获取的字段
        item_loader = TaobaoItemLoader(TaobaosplashItem(), response=response)
        item_loader.add_xpath('title','//div[@class="tb-item-info-r"]/div/div/div[1]/h3/text()')
        item_loader.add_xpath('stock','//div[@class="tb-skin"]/dl[3]/dd/em/span/text()')
        item_loader.nested_xpath('//div[@id="J_LogisticInfo"]/div[2]/span').add_xpath('freight','string(.)')
        item_loader.add_xpath('market_price','//div[@class="tb-wrap tb-wrap-newshop"]/ul[1]/li[1]/div/strong/em[2]/text()')
        item_loader.add_xpath('size','//div[@class="tb-skin"]/dl[1]/dd/ul/li/a/span/text()')
        item_loader.add_xpath('images','//div[@class="tb-gallery"]/ul/li/div/a/img/@src')
        item_loader.add_xpath('all_attributes','//div[@class="sub-wrap"]/div[@id="attributes"]/ul/li/text()')
        ...
        color_id = response.xpath('//div[@class="tb-skin"]/dl[2]/dd/ul/li/@data-value').extract()
        size_id = response.xpath('//div[@class="tb-skin"]/dl[1]/dd/ul/li/@data-value').extract()

        #color字段的获取
        link_items = response.xpath('//div[@class="tb-skin"]/dl[2]/dd/ul/li')
        color=[]
        color_list=[]
